...
public class Account {
    ...
    public void withdraw(double money) {
        ...
        synchronized后面小括号中传的这个“数据”是相当关键饿
        这个数据必须是多线程共享大的数据，才能达到多线程排队
        ...
        （）中写什么？
           ...
           以下代码的执行原理？
            ...
            找到之后，并占有这把锁，然后执行同步代码块中的程序，在程序执行过程中，一直都是
            占有这把锁的。直到同步代码块执行结束，这把锁才会释放。
...
//        synchronized (this) {
//        synchronized (obj) {
//            synchronized ("abc") {    //"abc"在字符串常量池当中。所有线程共享。
